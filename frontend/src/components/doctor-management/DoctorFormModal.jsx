...
import { departments, branches } from "../../data/doctorManagementData";
        ...
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6 text-center">
          ...
          <div className="bg-gray-50 rounded-lg p-4 text-left text-sm space-y-1.5">
            <p>
              ...
              <span className="font-mono">{generatedCreds.id}</span>
            </p>
            <p>
              <span className="text-gray-400">Employee ID:</span>{" "}
              <span className="font-mono">{generatedCreds.empId}</span>
            </p>
            <p>
            ...
            <p>
              ...
              <span className="font-mono">{generatedCreds.tempPassword}</span>
            </p>
          </div>
          <button
            onClick={onClose}
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4 py-8 overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl p-6 relative my-auto">
        ...
        <p className="text-sm text-gray-500 mb-5">
          {mode === "add"
            ? "Doctor ID, Employee ID, and login credentials will be auto-generated."
        ...
        >
          ...
          <input
            ...
            onChange={handleChange}
            placeholder="Working Hours (e.g. 09:00 AM - 05:00 PM)"
